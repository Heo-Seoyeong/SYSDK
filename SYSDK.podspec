...
Pod::Spec.new do |s|
  ...
  s.description      = 'Heo Seoyeong\'s Library for Swift!!'
  ...
  # Or just: s.author    = "Seoyeong"
  # s.authors            = { "Seoyeong" => "email@address.com" }
  # s.social_media_url   = ""
  ...
  s.source_files  = "SYSDK/Classes/**/*.{swift}"
